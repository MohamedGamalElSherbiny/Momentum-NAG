...
def implement_adagrad(x, y, epochs=50, alpha=0.001, epsilon=1e-8, theta0=0, theta1=0):
    ...
    for _ in range(epochs):
        ...
        if len(all_loss_functions) > 1:
            if round(all_loss_functions[-1], 5) == round(all_loss_functions[-2], 5):
                break
    return all_theta0, all_theta1, all_loss_functions, all_hypothesis, theta0, theta1, "Adagrad Method"
